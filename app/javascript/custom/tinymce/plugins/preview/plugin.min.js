    ...
    a.addCommand("mcePreview", function() {
        a.windowManager.open({
            ...
            onPostRender: function() {
                ...
                if (d = "<!DOCTYPE html><html><head>" + e + '</head><body id="' + f + '" class="mce-content-body ' + g + '"' + i + ">" + a.getContent() + h + "</body></html>", c) this.getEl("body").firstChild.src = "data:text/html;charset=utf-8," + encodeURIComponent(d);
                else {
